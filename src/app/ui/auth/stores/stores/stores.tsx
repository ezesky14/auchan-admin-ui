...
export default function Stores() {
    ...
    return (
        <div>
            <div className="flex flex-col lg:flex-row lg:items-center lg:gap-7 gap-4">
                <h1 className="text-3xl font-bold">{'Magasins'}</h1>
                <InputSearch className="w-80" placeholder="Nom du magasin, code magasin,Commune" />
                <Dropdown
                ...
                <Button size="sm" className="ml-auto rounded-xl px-2 h-12">
