          ...
          <form className="mt-7">
            {currentStep === 'email' && (
              <div>
                ...
                <Button type="button" onClick={handleContinueToOtp}>
            ...
            {currentStep === 'otp' && (
              <div>
                ...
                <Button type="button" onClick={handleContinueToNewPassword}>
            ...
            {currentStep === 'change' && (
              <div className="flex flex-col gap-4">
                ...
                <Button type="button" onClick={handleFinishChangePassword}>
                  {<span className="font-bold">{'Valider'}</span>}
                </Button>
              </div>
            )}
